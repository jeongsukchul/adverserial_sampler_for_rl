...
def make_inference_fn(gmmppo_networks: GMMPPONetworks):
  """Creates params and inference function for the GMMPPO agent."""

  def make_policy(
      params: types.Params, deterministic: bool = False
  ) -> types.Policy:
    policy_network = gmmppo_networks.policy_network
    parametric_action_distribution = gmmppo_networks.parametric_action_distribution
    ...
    def policy(
      ...
      if deterministic:
        return gmmppo_networks.parametric_action_distribution.mode(logits), {}
...
def make_gmmppo_networks(
  ...
  """Make GMMPPO networks with preprocessor."""
